...
#define ENROLL2(a,...) enroll(a, #a); ENROLL1(__VA_ARGS__)
#define ENROLL3(a,...) enroll(a, #a); ENROLL2(__VA_ARGS__)
#define ENROLL4(a,...) enroll(a, #a); ENROLL3(__VA_ARGS__)
#define ENROLL5(a,...) enroll(a, #a); ENROLL4(__VA_ARGS__)
#define ENROLL6(a,...) enroll(a, #a); ENROLL5(__VA_ARGS__)
